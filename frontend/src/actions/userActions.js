...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${PORT}/api/users/login`, { email, password }, config)
        dispatch({
...
export const register = (name, email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${PORT}/api/users`, { name, email, password }, config)
        dispatch({
...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`${PORT}/api/users/${id}`, config)
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`${PORT}/api/users/profile`, user, config)
...
export const listUsers = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`${PORT}/api/users`, config)
...
export const deleteUser = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`${PORT}/api/users/${id}`, config)
...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`${PORT}/api/users/${user._id}`, user, config)
